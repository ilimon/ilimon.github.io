...
function timeago() {
    function get_timeago(t) {
        var e = new Date(t),
            ...
            n = "Ago",
            l = new Date - e;
        return l < 6e4 ? Math.round(l / 1e3) + " detik " + n : l < a ? Math.round(l / 6e4) + " menit " + n : l < o ? Math.round(l / a) + " jam " + n : l < s ? Math.round(l / o) + " Days " + n : l < i ? Math.round(l / s) + " Month " + n : Math.round(l / i) + " Year " + n
    }
