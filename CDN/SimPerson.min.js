        ...
        $('[data-komentar]').each(function() {
            ...
            $.getJSON($_config['url']['home'] + 'feeds/comments/default?alt=json&max-results=' + $data_komentar, function(data) {
                ...
                $.each(data.feed.entry, function(key, value) {
                    ...
                    html += '<b>' + value.author[0].name.$t + '</b> comment ';

                    if (value["thr$in-reply-to"].href.includes('/p/')) {
                        html += 'page <a href="' + value.link[2].href + '">' + titleCase(value["thr$in-reply-to"].href.split('/')[4].replace('.html', '').replace(/-/g, ' ')) + '..</a>';
                    } else {
                        html += 'post <a href="' + value.link[2].href + '">' + titleCase(value["thr$in-reply-to"].href.split('/')[5].replace('.html', '').replace(/-/g, ' ')) + '..</a>';
                    }
                    html += '<br/>';
